  ...
  return (
    <div className="flex items-center flex-col px-4">
      ...
      <p className="font-['Montserrat'] text-[#5F5F5F] text-center whitespace-pre-line text-sm md:text-base max-w-2xl">
        {`Choose from thousands of hotels, apartments, villas, and resorts worldwide. Whether you’re 
traveling for business or leisure, find accommodations that suit your style and budget.`}
      </p>
