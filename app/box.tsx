        ...
        <div className="inline-flex items-start gap-3 absolute top-0 left-[calc(50.00%_-_396px)]">
          {tabs.map((tab) =>
            tab.id === "hotels" ? (
              ...
              >
                <button
                  className="all-[unset] box-border flex w-64 justify-center gap-5 px-[46px] py-4 flex-[0_0_auto] bg-white rounded-[42px] border border-solid items-center relative cursor-pointer"
              ...
              <button
                key={tab.id}
                className="all-[unset] box-border flex w-64 justify-center gap-5 px-[46px] py-4 bg-[#f5f5f53d] rounded-[42px] shadow-[0px_4px_8px_#00000033] backdrop-blur-[5px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(5px)_brightness(100%)] items-center relative cursor-pointer"
                onClick={() => setActiveTab(tab.id)}
                aria-pressed={activeTab === tab.id}
                aria-label={tab.label}
              >
        ...
        <div className="inline-flex flex-wrap items-end justify-center gap-[11px_11px] px-10 py-8 absolute top-[85px] left-0 bg-[#3964ae] rounded-xl shadow-[0px_6px_24px_#00020547]">
          <div className="relative w-[404.5px] h-[71px]">
            ...
            <input
              ...
              aria-label="Location"
              className="absolute top-[23px] left-px w-[400px] h-12 bg-transparent rounded border-0 outline-none px-3 [font-family:'Montserrat-SemiBold',Helvetica] font-semibold text-[#5f5f5f] text-[13px] tracking-[0] leading-[normal] placeholder:text-[#5f5f5f]"
            />
          ...
          <div className="w-[324px] relative h-[71px]">
            <div className="absolute top-[23px] left-px w-80 h-12 bg-white rounded border border-solid" />
            <input
              type="text"
              value={dateRange}
              ...
              className="absolute top-[23px] left-px w-80 h-12 bg-transparent rounded border-0 outline-none px-3 [font-family:'Montserrat-SemiBold',Helvetica] font-semibold text-[#5f5f5f] text-[13px] tracking-[0] leading-[normal] placeholder:text-[#5f5f5f]"
            />
          ...
          <div className="w-[324.5px] relative h-[71px]">
            <div className="absolute top-[23px] left-px w-80 h-12 bg-white rounded border border-solid" />
            <input
              type="text"
              value={guests}
            ...
            <div className="absolute top-[41px] left-[290px] w-3.5 h-3.5 flex pointer-events-none">
              <img className="flex-1 w-[10.15px]" alt="Vector" src={vector} />
            </div>
          </div>
          <div className="w-[284px] relative h-[71px]">
            <div className="w-[280px] absolute top-[23px] left-px h-12 bg-white rounded border border-solid" />
            <input
              type="text"
              value={priceRange}
              ...
              className="absolute top-[23px] left-px w-[280px] h-12 bg-transparent rounded border-0 outline-none px-3 [font-family:'Montserrat-SemiBold',Helvetica] font-semibold text-[#5f5f5f] text-[13px] tracking-[0] leading-[normal] placeholder:text-[#5f5f5f]"
            />
            <div className="absolute top-[41px] left-[252px] w-3.5 h-3.5 flex pointer-events-none">
          ...
          <button
            className="all-[unset] box-border inline-flex justify-end gap-2.5 px-12 py-3.5 flex-[0_0_auto] bg-[#f97101] rounded items-center relative cursor-pointer"
            type="button"
            aria-label="Search"
          >
